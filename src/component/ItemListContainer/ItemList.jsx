...
const ItemListContainer = () => {
    ...
    return (
        ...
        {producto && producto.map((producto=>
            ...
            <Item initial={initial} key={producto.id} nombre={producto.title} description={producto.description} stock={stock} onAdd={onAdd} removeAdd={removeAdd} checkStock={checkStock}   img={producto.pictureurl}/>
